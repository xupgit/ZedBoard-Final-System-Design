 ...
 PARAMETER NAME = C:\Xilinx\Projects\attention_detect\hdl-hdl_2015_r1\projects\adv7511\zed_working\adv7511_zed.sdk\zynq_fsbl_bsp\system.mss
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 5.0
 PARAMETER HW_INSTANCE = axi_vdma_img_process
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 5.0
 PARAMETER HW_INSTANCE = axi_vdma_img_process1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = toGray_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = toThreshold_0
END
