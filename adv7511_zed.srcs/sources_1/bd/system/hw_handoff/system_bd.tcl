...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_interconnect_img_process, and set properties
  set axi_interconnect_img_process [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_img_process ]
  set_property -dict [ list CONFIG.NUM_MI {1} CONFIG.NUM_SI {4}  ] $axi_interconnect_img_process
  ...
  # Create instance: axi_vdma_img_process, and set properties
  set axi_vdma_img_process [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vdma:6.2 axi_vdma_img_process ]
  set_property -dict [ list CONFIG.c_m_axi_mm2s_data_width {32} CONFIG.c_m_axis_mm2s_tdata_width {24} CONFIG.c_mm2s_max_burst_length {32} CONFIG.c_use_s2mm_fsync {0}  ] $axi_vdma_img_process

  # Create instance: axi_vdma_img_process1, and set properties
  set axi_vdma_img_process1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_vdma:6.2 axi_vdma_img_process1 ]
  set_property -dict [ list CONFIG.c_m_axi_mm2s_data_width {32} CONFIG.c_m_axis_mm2s_tdata_width {24} CONFIG.c_mm2s_max_burst_length {32} CONFIG.c_use_s2mm_fsync {0}  ] $axi_vdma_img_process1
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M07_AXI [get_bd_intf_pins axi_cpu_interconnect/M07_AXI] [get_bd_intf_pins axi_vdma_img_process/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M08_AXI [get_bd_intf_pins axi_cpu_interconnect/M08_AXI] [get_bd_intf_pins toGray_1/S_AXI_CONTROL]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M09_AXI [get_bd_intf_pins axi_cpu_interconnect/M09_AXI] [get_bd_intf_pins axi_vdma_img_process1/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M10_AXI [get_bd_intf_pins axi_cpu_interconnect/M10_AXI] [get_bd_intf_pins toThreshold_0/S_AXI_CONTROL]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_img_process/M00_AXI] [get_bd_intf_pins sys_ps7/S_AXI_HP1]
  ...
  connect_bd_intf_net -intf_net axi_vdma_img_process1_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_img_process1/M_AXIS_MM2S] [get_bd_intf_pins toThreshold_0/IN_STREAM]
  connect_bd_intf_net -intf_net axi_vdma_img_process1_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_img_process/S03_AXI] [get_bd_intf_pins axi_vdma_img_process1/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_vdma_img_process1_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_img_process/S02_AXI] [get_bd_intf_pins axi_vdma_img_process1/M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_vdma_img_process_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_img_process/M_AXIS_MM2S] [get_bd_intf_pins toGray_1/IN_STREAM]
  connect_bd_intf_net -intf_net img_process_vdma_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_img_process/S00_AXI] [get_bd_intf_pins axi_vdma_img_process/M_AXI_MM2S]
  connect_bd_intf_net -intf_net img_process_vdma_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_img_process/S01_AXI] [get_bd_intf_pins axi_vdma_img_process/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net toGray_1_OUT_STREAM [get_bd_intf_pins axi_vdma_img_process/S_AXIS_S2MM] [get_bd_intf_pins toGray_1/OUT_STREAM]
  connect_bd_intf_net -intf_net toThreshold_0_OUT_STREAM [get_bd_intf_pins axi_vdma_img_process1/S_AXIS_S2MM] [get_bd_intf_pins toThreshold_0/OUT_STREAM]
  ...
  connect_bd_net -net sys_cpu_clk [get_bd_pins axi_cpu_interconnect/ACLK] [get_bd_pins axi_cpu_interconnect/M00_ACLK] [get_bd_pins axi_cpu_interconnect/M01_ACLK] [get_bd_pins axi_cpu_interconnect/M02_ACLK] [get_bd_pins axi_cpu_interconnect/M03_ACLK] [get_bd_pins axi_cpu_interconnect/M04_ACLK] [get_bd_pins axi_cpu_interconnect/M05_ACLK] [get_bd_pins axi_cpu_interconnect/M06_ACLK] [get_bd_pins axi_cpu_interconnect/M07_ACLK] [get_bd_pins axi_cpu_interconnect/M08_ACLK] [get_bd_pins axi_cpu_interconnect/M09_ACLK] [get_bd_pins axi_cpu_interconnect/M10_ACLK] [get_bd_pins axi_cpu_interconnect/S00_ACLK] [get_bd_pins axi_hdmi_clkgen/s_axi_aclk] [get_bd_pins axi_hdmi_core/m_axis_mm2s_clk] [get_bd_pins axi_hdmi_core/s_axi_aclk] [get_bd_pins axi_hdmi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_hdmi_dma/m_axis_mm2s_aclk] [get_bd_pins axi_hdmi_dma/s_axi_lite_aclk] [get_bd_pins axi_hp0_interconnect/ACLK] [get_bd_pins axi_hp0_interconnect/M00_ACLK] [get_bd_pins axi_hp0_interconnect/S00_ACLK] [get_bd_pins axi_i2s_adi/DMA_REQ_RX_ACLK] [get_bd_pins axi_i2s_adi/DMA_REQ_TX_ACLK] [get_bd_pins axi_i2s_adi/S_AXI_ACLK] [get_bd_pins axi_iic_fmc/s_axi_aclk] [get_bd_pins axi_iic_main/s_axi_aclk] [get_bd_pins axi_interconnect_img_process/ACLK] [get_bd_pins axi_interconnect_img_process/M00_ACLK] [get_bd_pins axi_interconnect_img_process/S00_ACLK] [get_bd_pins axi_interconnect_img_process/S01_ACLK] [get_bd_pins axi_interconnect_img_process/S02_ACLK] [get_bd_pins axi_interconnect_img_process/S03_ACLK] [get_bd_pins axi_spdif_tx_core/DMA_REQ_ACLK] [get_bd_pins axi_spdif_tx_core/S_AXI_ACLK] [get_bd_pins axi_vdma_img_process/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_img_process/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_img_process/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_img_process/s_axi_lite_aclk] [get_bd_pins axi_vdma_img_process/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_img_process1/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_img_process1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_img_process1/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_img_process1/s_axi_lite_aclk] [get_bd_pins axi_vdma_img_process1/s_axis_s2mm_aclk] [get_bd_pins sys_ps7/DMA0_ACLK] [get_bd_pins sys_ps7/DMA1_ACLK] [get_bd_pins sys_ps7/DMA2_ACLK] [get_bd_pins sys_ps7/FCLK_CLK0] [get_bd_pins sys_ps7/M_AXI_GP0_ACLK] [get_bd_pins sys_ps7/S_AXI_HP0_ACLK] [get_bd_pins sys_ps7/S_AXI_HP1_ACLK] [get_bd_pins sys_rstgen/slowest_sync_clk] [get_bd_pins toGray_1/aclk] [get_bd_pins toThreshold_0/aclk]
  connect_bd_net -net sys_cpu_reset [get_bd_pins sys_rstgen/peripheral_reset]
  connect_bd_net -net sys_cpu_resetn [get_bd_pins axi_cpu_interconnect/ARESETN] [get_bd_pins axi_cpu_interconnect/M00_ARESETN] [get_bd_pins axi_cpu_interconnect/M01_ARESETN] [get_bd_pins axi_cpu_interconnect/M02_ARESETN] [get_bd_pins axi_cpu_interconnect/M03_ARESETN] [get_bd_pins axi_cpu_interconnect/M04_ARESETN] [get_bd_pins axi_cpu_interconnect/M05_ARESETN] [get_bd_pins axi_cpu_interconnect/M06_ARESETN] [get_bd_pins axi_cpu_interconnect/M07_ARESETN] [get_bd_pins axi_cpu_interconnect/M08_ARESETN] [get_bd_pins axi_cpu_interconnect/M09_ARESETN] [get_bd_pins axi_cpu_interconnect/M10_ARESETN] [get_bd_pins axi_cpu_interconnect/S00_ARESETN] [get_bd_pins axi_hdmi_clkgen/s_axi_aresetn] [get_bd_pins axi_hdmi_core/s_axi_aresetn] [get_bd_pins axi_hdmi_dma/axi_resetn] [get_bd_pins axi_hp0_interconnect/ARESETN] [get_bd_pins axi_hp0_interconnect/M00_ARESETN] [get_bd_pins axi_hp0_interconnect/S00_ARESETN] [get_bd_pins axi_i2s_adi/DMA_REQ_RX_RSTN] [get_bd_pins axi_i2s_adi/DMA_REQ_TX_RSTN] [get_bd_pins axi_i2s_adi/S_AXI_ARESETN] [get_bd_pins axi_iic_fmc/s_axi_aresetn] [get_bd_pins axi_iic_main/s_axi_aresetn] [get_bd_pins axi_interconnect_img_process/ARESETN] [get_bd_pins axi_interconnect_img_process/M00_ARESETN] [get_bd_pins axi_interconnect_img_process/S00_ARESETN] [get_bd_pins axi_interconnect_img_process/S01_ARESETN] [get_bd_pins axi_interconnect_img_process/S02_ARESETN] [get_bd_pins axi_interconnect_img_process/S03_ARESETN] [get_bd_pins axi_spdif_tx_core/DMA_REQ_RSTN] [get_bd_pins axi_spdif_tx_core/S_AXI_ARESETN] [get_bd_pins axi_vdma_img_process/axi_resetn] [get_bd_pins axi_vdma_img_process1/axi_resetn] [get_bd_pins sys_audio_clkgen/resetn] [get_bd_pins sys_rstgen/peripheral_aresetn] [get_bd_pins toGray_1/aresetn] [get_bd_pins toThreshold_0/aresetn]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces axi_vdma_img_process/Data_MM2S] [get_bd_addr_segs sys_ps7/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_sys_ps7_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces axi_vdma_img_process/Data_S2MM] [get_bd_addr_segs sys_ps7/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_sys_ps7_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces axi_vdma_img_process1/Data_MM2S] [get_bd_addr_segs sys_ps7/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_sys_ps7_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces axi_vdma_img_process1/Data_S2MM] [get_bd_addr_segs sys_ps7/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_sys_ps7_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x10000 -offset 0x43030000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs axi_vdma_img_process1/S_AXI_LITE/Reg] SEG_axi_vdma_img_process1_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43010000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs axi_vdma_img_process/S_AXI_LITE/Reg] SEG_axi_vdma_img_process_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs toGray_1/S_AXI_CONTROL/Reg] SEG_toGray_1_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs toThreshold_0/S_AXI_CONTROL/Reg] SEG_toThreshold_0_Reg
